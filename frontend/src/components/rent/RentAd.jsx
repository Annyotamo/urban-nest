...
const RentAd = ({ toggle }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className="bg-white p-6 md:p-8 rounded-lg shadow-xl max-w-5xl mx-auto"
                style={{ backgroundColor: '#E9EDC9' }}
            >
                <h1
                    className="text-3xl md:text-6xl font-extrabold text-center mb-6"
                    style={{ color: '#D4A373' }}
                >
                    ...
                    >
                        {images.concat(images).map((src, index) => (
                            <img
                                ...
                                className="rounded-lg shadow-md object-cover h-48 md:h-60 w-72 md:w-96 flex-shrink-0"
                            />
                        ))}
                    </div>
                </div>
                ...
                <div className="text-center">
                    <p className="text-base md:text-xl mb-8 leading-relaxed" style={{ color: '#CCD5AE' }}>
                    ...
                    <ul className="text-left text-base md:text-xl space-y-3 mb-8">
